...
func TestDefaults(t *testing.T) {
	...
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 0))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 1))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 25))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 45335))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 222874-1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 222874))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 222874+1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, math.MaxInt32-1))
	...
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 0))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 1))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 25-1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 25))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 25+1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, math.MaxInt32-1))
	...
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 0))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 1))
	assert.False(t, IsActive(AUTHORITY_SET_MAX_DELTA, 109387-1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 109387))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 109387+1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, math.MaxInt32-1))
	...
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 0))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 1))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 25))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 45335))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, 222874))
	assert.True(t, IsActive(AUTHORITY_SET_MAX_DELTA, math.MaxInt32-1))
}
