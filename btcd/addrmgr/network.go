...
func IsIPv4(na *messages.NetAddress) bool {
	return na.IP.To4() != nil
}

// IsLocal returns whether or not the given address is a local address.
func IsLocal(na *messages.NetAddress) bool {
...
// IPv6 range.
func IsOnionCatTor(na *messages.NetAddress) bool {
...
func IsRFC1918(na *messages.NetAddress) bool {
...
func IsRFC2544(na *messages.NetAddress) bool {
...
func IsRFC3849(na *messages.NetAddress) bool {
...
func IsRFC3927(na *messages.NetAddress) bool {
...
func IsRFC3964(na *messages.NetAddress) bool {
	return rfc3964Net.Contains(na.IP)
}

// IsRFC4193 returns whether or not the passed address is part of the IPv6
// unique local range as defined by RFC4193 (FC00::/7).
func IsRFC4193(na *messages.NetAddress) bool {
...
func IsRFC4380(na *messages.NetAddress) bool {
...
func IsRFC4843(na *messages.NetAddress) bool {
...
func IsRFC4862(na *messages.NetAddress) bool {
...
func IsRFC5737(na *messages.NetAddress) bool {
...
func IsRFC6052(na *messages.NetAddress) bool {
...
func IsRFC6145(na *messages.NetAddress) bool {
...
func IsRFC6598(na *messages.NetAddress) bool {
...
func IsValid(na *messages.NetAddress) bool {
...
func IsRoutable(na *messages.NetAddress) bool {
...
// address.
func GroupKey(na *messages.NetAddress) string {
	if IsLocal(na) {
		return "local"
	}
	if !IsRoutable(na) {
