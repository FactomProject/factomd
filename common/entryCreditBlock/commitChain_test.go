...
// TestCommitChainMarshalUnmarshal creates a new commit chain with specific values, and then marshals and unmarshals it, then checks
// whether the signature of the second object is valid
...
// TestCommitChainMarshalUnmarshalStatic unmarshals a specific hex string into a commit chain and checks that the hashes are as expected
...
// TestCommitChainMarshalUnmarshalEmpty creates a new empy commit chain, marshals and unmarshals it, checking for any errors
...
// TestMiscCC decodes a specific chain commit and checks that its entries are as expected
...
// TestCommitChainIsValid checks that a commit chain with varying entry credits is valid or invalid depending on the value
