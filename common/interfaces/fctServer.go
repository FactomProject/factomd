...
var _ BinaryMarshallable = (*FctServer)(nil)

func (s *FctServer) MarshalBinary() ([]byte, error) {
	return nil, nil
}

func (s *FctServer) UnmarshalBinaryData(p []byte) (newData []byte, err error) {
	return
}

func (s *FctServer) UnmarshalBinary(p []byte) error {
	return nil
}
