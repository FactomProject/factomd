...
func (m *PromotionDemotion) Process(uint32, interfaces.IState) bool { return true }
...
func (m *PromotionDemotion) GetMsgHash() interfaces.IHash {
	if m.MsgHash == nil {
...
//  1   -- Message is valid
func (m *PromotionDemotion) Validate( state interfaces.IState) int {
	return 0
}
