...
func (db *Overlay) ProcessEBlockBatch(eblock DatabaseBatchable) error {
...
func (db *Overlay) FetchEBlockByHash(hash IHash, dst DatabaseBatchable) (DatabaseBatchable, error) {
...
func (db *Overlay) FetchEBlockByKeyMR(hash IHash, dst DatabaseBatchable) (DatabaseBatchable, error) {
	return db.FetchBlock([]byte{byte(TBL_EB)}, hash, dst)
}

// FetchEBHashByMR gets an entry by hash from the database.
func (db *Overlay) FetchEBKeyMRByHash(hash IHash) (IHash, error) {
...
func (db *Overlay) FetchAllEBlocksByChain(chainID IHash, sample BinaryMarshallableAndCopyable) ([]BinaryMarshallableAndCopyable, error) {
