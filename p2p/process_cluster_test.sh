...
# 
    ...
    factomd -count=2 -folder="test1-" -port=9120 -p2pPort="34340" -peers="127.0.0.1:34341" -netdebug=2 & node0=$!
    sleep 6
    factomd -count=2 -folder="test2-" -prefix="test2-" -port=9121 -p2pPort="34341" -peers="127.0.0.1:34340" -netdebug=2 & node1=$!
