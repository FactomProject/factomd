...
func LaggingAuditElection(t *testing.T, lag int) {
	state0 := SetupSim("LLLAF", map[string]string{"--debuglog": ".", "--blktime": "15"}, 20, 0, 0, t)
