...
func GetHardCodedGrants() []HardGrant {
	...
	case "MAIN":
		...
		hardcodegrants = []HardGrant{
			...
			// Factom Inc. total: 900 FCT
			HardGrant{207325, 900e8, validateAddress("FA3fpiZ91MCRRFjVGfNXK4pg7vx3BT3aSRyoVqgptZCX7N5BNR8P")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 660e8, validateAddress("FA3jySUFtLXb1VdAJJ5NRVNYEtZ4EBSkDB7yn6LuKGQ4P1ntARhx")},
			// --------------------------------------------------------
			...
			// Factom Inc. total: 1800 FCT
			HardGrant{207325, 1800e8, validateAddress("FA2teRURMYTdYAA97zdh7rZDkxNtR1nhjryo34aaskjYqsqRSwZq")},

			// TRGG3R LLC total: 1800 FCT
			HardGrant{207325, 1800e8, validateAddress("FA2oecgJW3XWnXzHhQQoULmMeKC97uAgHcPd4kEowTb3csVkbDc9")},

			// DBGrow Inc total: 1800 FCT
			HardGrant{207325, 1800e8, validateAddress("FA3HSuFo9Soa5ZnG82JHqyKiRi4Pw17LxPTo9AsCaFNLCGkXkgsu")},

			// The 42nd Factoid AS total: 1800 FCT
			HardGrant{207325, 1800e8, validateAddress("FA3AEL2H9XZy3n199USs2poCEJBkK1Egy6JXhLehfLJjUYMKh1zS")},

			// Centis BV total: 1800 FCT
			HardGrant{207325, 1800e8, validateAddress("FA2hvRaci9Kks9cLNkEUFcxzUJuUFaaAE1eWYLqa2qk1k9pVFVBp")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 8747e8, validateAddress("FA3nsSjUy5uSkqMEug8t3VcehZn5w2ciSMpgqFEEsMRwMrHoa9k3")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 8093e8, validateAddress("FA3P6cLv2Ct2P6SStqhhqagFp9u8kpca9XyJHbhB68v1jeZNFpG8")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 188e8, validateAddress("FA2LV4s7LKA9BTgWaJNvcr9Yq8rpiH2XD3vEPY3nwSiNSrnRgkpK")},

			// Crypto Logic total: 188 FCT
			HardGrant{207325, 188e8, validateAddress("FA29wMUjN38BVLbJs6dR6gHHdBys2mpo3wy565JCjquUQTGqNZfb")},

			// Bedrock Solutions total: 375 FCT
			HardGrant{207325, 375e8, validateAddress("FA2FqYZPfBeRWq7fWSFEhassT5zpMQZm8jwus3yWbzeN3PZPWybm")},

			// De Facto total: 375 FCT
			HardGrant{207325, 375e8, validateAddress("FA2YeMbN8Z1SsT7Yqw6Np85kWwtFVg2CyJKMDFnuXTawWuWPtzvX")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 200e8, validateAddress("FA35Kd1Ac1aQXEHPxYTR6jNDPuwVoh6APQQGKViceQTedyE7J2vV")},

			// Canonical Ledgers total: 5500 FCT
			HardGrant{207325, 5500e8, validateAddress("FA2xccSAfhGm5k4tPaXF9741xkQ52drWjoJodQhpPxDxepdqasMM")},

			// DBGrow total: 7550 FCT
			HardGrant{207325, 7550e8, validateAddress("FA3HSuFo9Soa5ZnG82JHqyKiRi4Pw17LxPTo9AsCaFNLCGkXkgsu")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 22500e8, validateAddress("FA2LwHgp7LyoY5SG1vxjLaQ2QtdyepfaqYUTsiTgprtkiP6geCk7")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 2950e8, validateAddress("FA2tsEih6kyzNSBtbkzZ31HUGF8QQB7RPBFouBVfYyUZk24QkPr2")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 10000e8, validateAddress("FA3i8WbLoRvmWmpRLEBYENLZdEBK9TNG74UWrvHAGWgAyW11iHBu")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 680e8, validateAddress("FA28qK3QjFEupwjmY3qvM1CdNCrik33my8fdmxJwj1ea5iKCnbXF")},
			// --------------------------------------------------------
			...
			HardGrant{207325, 2400e8, validateAddress("FA3KMPNX8AKdY3tjyKMzZ5cAkqUv97d3QqkJeQnVXk6PXSVgArnr")},
			// --------------------------------------------------------
		}
