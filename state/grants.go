...
func GetHardCodedGrants() []HardGrant {
	...
	case "LOCAL":
		hardcodegrants = []HardGrant{
			...
			HardGrant{21, 36494e8, validateAddress("FA3LwCDE3ZdFkr9nE1Keb5JcHgwXVWpEHydshT1x2qKFdvZELVQz")},
	...
	case "MAIN":
		...
		hardcodegrants = []HardGrant{
			...
			// Factom-Inc-015 -- 36494 FCT
			// Protocol Development -- (2019-06-09 - 2019-09-09)
			HardGrant{195126, 36494e8, validateAddress("FA3LwCDE3ZdFkr9nE1Keb5JcHgwXVWpEHydshT1x2qKFdvZELVQz")},
			// Sponsor 1, Dominic Luxford -- 300 FCT
