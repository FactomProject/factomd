...
func PrintState(state *State) {
	...
	str = fmt.Sprintf("%s %35s = %+v\n", str, "serverPrt", state.serverPrt.LoadString())
	...
	str = fmt.Sprintf("%s %35s = %+v\n", str, "EntryDBHeightComplete", state.EntryDBHeightComplete.LoadUint32())
	str = fmt.Sprintf("%s %35s = %+v\n", str, "EntryHeightComplete", state.EntryDBHeightComplete.LoadUint32())
